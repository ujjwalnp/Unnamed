...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="navbar">
        ...
        <div
          className={
            "absolute center bg-white md:w-[800px] max-sm:w-full max-sm:pr-10 m-auto   top-full mt-0.5   md:border-0 md:block md:relative md:inset-0 md:p-0  md:show " +
  ...
  <i className="fi fi-rr-search text-xl text-dark-grey"></i>
        ...
        <div className="flex items-center gap-5 md:gap-6 ml-auto">
          ...
          <Link to="/about" className="max-md:btn-light btn-dark py-3 px-9  md:block">
            About
          </Link>
        </div>
      </nav>
